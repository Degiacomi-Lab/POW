...
if rank == 0:
	...
	print '\n> PREPROCESSING %s\n'%sys.argv[1].split('.')[0]
        ...
        params=mode.Parser() #read user defined variables
	...
	params.check_standard_variables() #check consistency of standard variables
	params.check_variables() #check consistency of user defined variables
